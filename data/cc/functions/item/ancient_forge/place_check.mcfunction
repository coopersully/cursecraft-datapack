...
execute if entity @e[type=minecraft:marker,tag=ancient_forge,distance=..20] run function cc:item/ancient_forge/invalid/another_forge

execute unless entity @s[tag=invalid_place] run function cc:item/ancient_forge/place
