...
execute as @a[distance=..5] at @s run playsound minecraft:block.enchantment_table.use player @s ~ ~ ~ 4 2
data merge entity @s {Item:{tag:{stageOne:0b,stageTwo:1b,display:{Lore:['{"text":"Stage: 2/5","color":"gray","italic":"false","bold":"true"}','{"text":"Ex Obscurum","color":"dark_gray"}']}}}}
