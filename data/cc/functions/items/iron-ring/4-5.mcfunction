...
execute as @a[distance=..5] at @s run playsound minecraft:block.enchantment_table.use player @s ~ ~ ~ 4 0.5
data merge entity @s {Item:{tag:{stageFour:0b,stageFive:1b,display:{Lore:['{"text":"Stage: 5/5","color":"gray","italic":"false","bold":"true"}','{"text":"Ex Obscurum","color":"dark_gray"}']}}}}
